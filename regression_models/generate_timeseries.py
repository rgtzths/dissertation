...
def generate_main_timeseries(dfs, is_test, timeframe, overlap, timestep, interpolate):
    """
...
def generate_appliance_timeseries(dfs, timeframe, overlap, timestep, column, interpolate):
    """
    Converts an array of dataframes with the format timestamp : value into an
    array of values.
