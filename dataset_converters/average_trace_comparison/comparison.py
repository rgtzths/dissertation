...
def convert_aveiro(filename, output_path, timestep):
    """
    Parameters
    ----------
    filename : str
...
def convert_aveiro_traces(filename, output_path, timestep, interpolate):
    """
    Parameters
    ----------
    filename : str
...
if __name__ == "__main__":
    ...
    if create_csv:
        averaged_dates = convert_aveiro(input_file, output_path, timestep)
        
        convert_aveiro_traces(input_file, output_path, timestep, "previous")
        convert_aveiro_traces(input_file, output_path, timestep, "linear")
